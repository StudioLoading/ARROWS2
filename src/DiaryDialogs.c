...
void GetLocalizedDDLabel_EN(DD_TO_BE_LOCALIZED label, char* d) BANKED{
	switch(label){
		...
		case BROKENSHIP_D0:memcpy(d, "BRING 50 PIECES   ", 20); break;
		case BROKENSHIP_D1:memcpy(d, "OF WOOD TO BOB    ", 20); break;
		case BROKENSHIP_D2:memcpy(d, "THE SHIP CAN BE   ", 20); break;
		case BROKENSHIP_D3:memcpy(d, "REPAIRED!         ", 20); break;
		case STRIKE_TITLE:memcpy(d, "THE STRIKE     ", 16);break;
		case STRIKE_D0:memcpy(d, "I MUST FIND 6 MUSH ", 20); break;
		case STRIKE_D1:memcpy(d, "ROOMS              ", 20); break;
		case STRIKE_D2:memcpy(d, "BRING SHROOMS TO   ", 20); break;
		case STRIKE_D3:memcpy(d, "MARTIN             ", 20); break;
