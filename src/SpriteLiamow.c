...
const UINT8 liamow_anim_down[] = {4, 9, 0, 9, 1}; //The first number indicates the number of frames
const UINT8 liamow_anim_up[] = {4, 4,3,4,2}; //The first number indicates the number of frames
const UINT8 liamow_anim_h[] = {4, 5, 7, 6, 7}; //The first number indicates the number of frames
const UINT8 liamow_anim_idle_h[] = {1, 7}; //The first number indicates the number of frames
const UINT8 liamow_anim_idle_up[] = {1, 4}; //The first number indicates the number of frames
const UINT8 liamow_anim_idle_down[] = {6, 8,8,8,8,9,10}; //The first number indicates the number of frames
...
void liamownormal_setanim_walkh() BANKED;
void liamownormal_setanim_walkup() BANKED;
void liamownormal_setanim_walkdown() BANKED;
void liamownormal_setanim_idleh() BANKED;
void liamownormal_setanim_idledown() BANKED;
void liamownormal_setanim_idleup() BANKED;
...
void liamownormal_setanim_walkh() BANKED{
    SetSpriteAnim(THIS, liamow_anim_h, 10u);
}
void liamownormal_setanim_walkup() BANKED{
    SetSpriteAnim(THIS, liamow_anim_up, 12u);
}
void liamownormal_setanim_walkdown() BANKED{
    SetSpriteAnim(THIS, liamow_anim_down, 12u);
}
void liamownormal_setanim_idleh() BANKED{
    SetSpriteAnim(THIS, liamow_anim_idle_h, 4u);
}
void liamownormal_setanim_idledown() BANKED{
    SetSpriteAnim(THIS, liamow_anim_idle_down, 4u);
}
void liamownormal_setanim_idleup() BANKED{
    SetSpriteAnim(THIS, liamow_anim_idle_up, 4u);
}
