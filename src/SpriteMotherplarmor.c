...
const UINT8 motherplarmor_anim_idle[] = {4, 1, 1, 1, 2}; //The first number indicates the number of frames
const UINT8 motherplarmor_anim_walk[] = {4, 3, 4, 3, 5};
const UINT8 motherplarmor_anim_walk_hit[] = {8, 3, 0, 4, 0, 3, 0, 5, 0};
const UINT8 motherplarmor_anim_jump_ascending[] = {1, 6};
const UINT8 motherplarmor_anim_jump_descending[] = {1, 5};
const UINT8 motherplarmor_anim_shoot[] = {1, 7};//7, 8, 7
const UINT8 motherplarmor_anim_crawlshoot[] = {3, 8, 8, 8};//9, 10, 9
const UINT8 motherplarmor_anim_hit[] = {2, 0, 1};
const UINT8 motherplarmor_anim_dead[] = {2, 0, 1};
const UINT8 motherplarmor_anim_crawl[] = {1, 8};
const UINT8 motherplarmor_anim_blocked[] = {2, 2, 1};
const UINT8 motherplarmor_anim_dash[] = {1, 9}; 
...
void motherplarmor_setanim_shoot() BANKED;
void motherplarmor_setanim_ascending() BANKED;
void motherplarmor_setanim_crawl() BANKED;
void motherplarmor_setanim_hit() BANKED;
void motherplarmor_setanim_dead() BANKED;
void motherplarmor_setanim_blocked() BANKED;
...
void motherplarmor_setanim_shoot() BANKED{
    SetSpriteAnim(THIS, motherplarmor_anim_shoot, 4u);
    if(motherpl_state == MOTHERPL_CRAWL){SetSpriteAnim(THIS, motherplarmor_anim_crawlshoot, 16u);}
}

void motherplarmor_setanim_ascending() BANKED{
    SetSpriteAnim(THIS, motherplarmor_anim_jump_ascending, 4u);
}

void motherplarmor_setanim_crawl() BANKED{
    SetSpriteAnim(THIS, motherplarmor_anim_crawl, 2u);
}
...
void motherplarmor_setanim_dead() BANKED{
    SetSpriteAnim(THIS, motherplarmor_anim_dead, 32u);
}

void motherplarmor_setanim_blocked() BANKED{
    SetSpriteAnim(THIS, motherplarmor_anim_blocked, 32u);
}
...
void motherplarmor_refreshAnimation() BANKED{
    switch(motherpl_state){
        case MOTHERPL_IDLE:
            SetSpriteAnim(THIS, motherplarmor_anim_idle, 4u + (8 - (motherpl_hp << 1) ));
        break;
        case MOTHERPL_WALK:
            SetSpriteAnim(THIS, motherplarmor_anim_walk, 12u);
        break;
        case MOTHERPL_JUMP:
            if(motherpl_vy > 0){
                SetSpriteAnim(THIS, motherplarmor_anim_jump_descending, 4u);
            }else{
                SetSpriteAnim(THIS, motherplarmor_anim_jump_ascending, 4u);
            }
        break;
        ...
        case MOTHERPL_HIT:        
            if(motherpl_vx != 0 ){
                SetSpriteAnim(THIS, motherplarmor_anim_walk_hit, 24u);
            }else{
